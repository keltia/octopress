...
C'est une voiture superbe, plus grosse — quoique, seulement 50 cm de plus que ma Prius, très bien finie, avec un équipement qui interpelle beaucoup le geek qui sommeille en moi avec une jolie nterface bien faite et efficace pour tous les paramètres de la voiture (auto-radio intégré avec FM/AM et Internet via TuneIn et Rdio), les équipements (toit ouvrant commandable au volant, caméra arrière pour les créneaux voire la conduite, un coffre énorme (700 l à l'arrière et 100 l à l'avant sur les modèles double moteurs), une ligne incomparable. Très spacieuse à l'intérieur, assez sobre ce qui me plait bien.
